export const appStrings = {
  ...
  aboutPage: {
    ...
    whatIsAppText:
      "This application serves as a virtual interviewer using questions fetched from chatGPTs API. AI is not perfect, and occasionally questions may be irrelevant or weirdly formatted, but you can always fetch a new question.",
    howToUseBlock: {
      howToUse: "How to Use:",
      stepOne:
    ...
    notesBlock: {
      ...
      noteTwo: "Background is from Pexels.",
      noteThree: "Robot icon generated by AI via Canva.com.",
      noteFour: "User notes are encrypted and are only accessible by you.",
    },
    contactBlock: {
      contact: "Contact Me:",
      linkedIn: "LinkedIn",
